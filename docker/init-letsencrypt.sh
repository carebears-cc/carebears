...
WWW_DOMAIN="$DOMAIN"
RSA_KEY_SIZE=2048
DATA_PATH="./certbot_data" # Where Certbot will store its config and certs on the host
EMAIL="your_email@example.com" # Replace with your email for urgent renewals
